...
public:
    ...
    // Daten validiert.
    Address(const std::string &street, const std::int32_t streetNo, const std::string zipcode, const std::string city, const std::string country);
    ...
    const bool isOnlyNumber(std::string str);
};
